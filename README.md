...
| Repo | What it does |
|---|---|
| [oncall-handoff-coordinator](https://github.com/SwethaJustin1/oncall-handoff-coordinator) | 2-agent ADK (TypeScript) pipeline: drafts on-call handoff notes, then reviews them against a completeness checklist before handoff |
| [closed-loop-verifier](https://github.com/SwethaJustin1/closed-loop-verifier) | Audit layer that independently re-checks metrics after incident resolution to catch false ticket closures |
| [incident-triage-assistant](https://github.com/SwethaJustin1/incident-triage-assistant) | RAG-based IT incident triage — retrieval classifies, LLM explains, no paid APIs |
| [alert-incident-correlator](https://github.com/SwethaJustin1/alert-incident-correlator) | Groups noisy monitoring alerts into incidents by similarity/time-window |
| [Contract-review-Agent](https://github.com/SwethaJustin1/Contract-review-Agent) | AI agent for contract review |
